...
| Pest Test (AC-01 sd AC-10) | ✅ Selesai | 40 test, 193 assertions — SEMUA PASS |
...
- `tests/Feature/AcceptanceSiswaAksesTest.php` (4 test): Siswa hanya lihat nilai sendiri, 403 forbidden akses halaman guru/admin, siswa nonaktif ditolak
